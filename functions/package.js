	...
	ZoomPic.prototype = 
	{
		...
		doMove : function (oElement, oAttr, fnCallBack)
		{
			...
			(function(oElement, oAttr){
				$(oElement).animate({'width':oAttr['width']+'px', 'height':oAttr['height']+'px', 'top':oAttr['top']+'px',
									'left':oAttr['left']+'px', 'zIndex':oAttr['zIndex']}, {'speed':'fast', 'easing':'swing', 'callback':function(){
